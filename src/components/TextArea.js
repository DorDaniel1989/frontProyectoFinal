  ...
  return (
    <div className="comments-container">
      <form>
        ...
        <a><button onClick={PostComentario} type="button"  className={"text-light border border-warning bg-transparent btn btn-añadir-comentario "+props.display} >Añadir comentario</button></a>
